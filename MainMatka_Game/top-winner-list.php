        ...
        <div id="content">
            ...
            <div class="top-winners-page">
                <header class="top-winners-hero text-center">
                    ...
                    <h1 class="top-winners-hero__title">Top Winner List</h1>
                    ...
                    <div class="card-body top-winner-card__inner">
                        ...
                        <div class="top-winner-card__meta-row">
                            <div class="top-winner-card__meta-left">
                                <i class="fa fa-gamepad top-winner-card__ico"></i>
                                <small class="top-winner-card__meta"><?php echo get_gameNameById($row['game_id']);?></small>
                            </div>
